...
@Configuration
@EnableJpaRepositories("com.mondula.training.spring.service.repositories")
@EnableTransactionManagement // similiar to <tx:annotation-driven/>
@ComponentScan(basePackages = "com.mondula.training.spring.service.entities")
public class JPAConfiguration {
	private static final String JAVAX_JDBC = "javax.persistence.jdbc.";
	private static final String ENTITY_BASE = "com.mondula.training.spring.service.entities";
